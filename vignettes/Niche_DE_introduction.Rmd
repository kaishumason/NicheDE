...
The output of the function is a niche-DE object with the nicheDE slot filled. If you see an error that says 'error some number', then for some reason niche-DE was unable to run on that gene number.\
